...
function mainStart() {
  ...
  mStart.addEventListener("click", () => {
    ...
    for (i = 0; i < all_btns.length; i++) {
      all_btns[i].addEventListener("click", (e) => {
        ...
        if (you === "batting") {
          ...
          if(random!==click){
            scoreRight += click;
            scoreDiv.innerText = scoreRight
          }else{
            scoreDiv.innerText = 'out'
            you = 'bowling'
            right.innerText = ''
            left.innerText = ''
            rightBase.innerText = `your score : ${scoreRight}`
          }
